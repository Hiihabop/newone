...
const Terms_of_service = () => {
  return (
    <div>
      <div className="p-7 shopify-policy__container">
        ...
        <div className="shopify-policy__body">
          <div className="rte">
            ...
            <p>
              <span>
                This website is operated by CLStore. Throughout the site, the
                terms “we”, “us” and “our” refer to CLStore. CLStore offers this
            ...
            <p>
              <span>
                <b>Section 1 - Online Store Term</b>
                <br />
              </span>
            </p>
            <p>
            ...
            <p>
              ...
              <span>For more detail, please review our Returns Policy.</span>
            </p>
            <p>
            ...
            <p>
              <span>
                In no case shall CLStore, our directors, officers, employees,
            ...
            <p>
              <span>
                You agree to indemnify, defend and hold harmless CLStore and our
