...
import { Account, getone } from "../Axios/axios";
...
const Payment = () => {
  ...
  const openUPIApp = () => {
    ...
    let upiUrl = "";
    const paymentAmount = Getoneitem.selling_price * qty;
  ...
  return (
    <div>
      ...
      <div className="max-w-2xl mx-auto p-[16px] font-sans pt-0 max-h-screen">
        ...
        {/* staep 1 */}
        {step === 1 && (
          <div className="space-y-4 h-96 border-t-2">
            ...
            <div className="border-t-4 pt-2">
              ...
              <div className="flex mt-3 justify-between underline decoration-dotted">
                ...
                <span>₹{Getoneitem.selling_price * qty}.00</span>
              </div>
              <div className="flex justify-between font-medium border-t-2 border-b-4 mt-3 py-3">
